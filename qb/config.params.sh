...
HAVE_CORE_INFO_CACHE=no    # Core info cache support
...
HAVE_VIDEO_FILTER=no       # Video filter support
...
HAVE_GFX_WIDGETS=no        # Enable graphics widgets
HAVE_RGUI=no               # RGUI menu
...
HAVE_OVERLAY=no            # Overlay support
...
HAVE_ACCESSIBILITY=no      # Accessibility Integration
