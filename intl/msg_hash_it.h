...
MSG_HASH(
   ...
   "Scarica miniature e configurazioni."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Scarica le miniature dei giochi per Nintendo 64 nell'elenco dei giochi selezionati."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Scarica le configurazioni di gioco per i giochi per Nintendo 64."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Scarica i file di mappatura chiave"
   )
MSG_HASH(
   MENU_ENUM_SUBLABEL_UPDATE_DATABASES,
   "Scarica i file di mappatura dei pulsanti di input per i giochi Nintendo 64."
   )
...
MSG_HASH(
   ...
   "I pacchetti texture (.htc/.hts) devono essere memorizzati in /data/Mupen64plus/cache/ e il BIOS 64DD (64DD_IPL.bin) nella directory /data/."
   )
MSG_HASH(
...
MSG_HASH( /* FIXME Not RGUI specific */
   ...
   "Emulatore e configurazioni di gioco (configs)"
   )
MSG_HASH( /* FIXME Not RGUI specific */
   MENU_ENUM_SUBLABEL_RGUI_CONFIG_DIRECTORY,
   "Online Updater supporta solo l'archiviazione nella cartella LocalState standard interna. Se questa impostazione viene modificata, il download facoltativo deve essere aggiunto manualmente. Vedi il link nella pagina Github."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Gli elenchi di giochi sono memorizzati in questa directory."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Tutti i dati di salvataggio sono memorizzati in questa directory."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "I salvataggi rapidi sono memorizzati in questa directory."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Rinomina il titolo di questo gioco per Nintendo 64."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Rimuovi questo gioco per Nintendo 64 dall'elenco dei giochi."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Specifica l'emulatore associato a questo gioco per Nintendo 64."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Ripristina emulatore associato a questo gioco Nintendo 64."
   )
MSG_HASH(
...
MSG_HASH(
   ...
   "Seleziona il database Nintendo 64 adatto per creare la tua playlist."
   )
MSG_HASH(
   MENU_ENUM_LABEL_VALUE_MANUAL_CONTENT_SCAN_SYSTEM_NAME_USE_CUSTOM,
   "(se non vengono visualizzati database, è necessario scaricarli nel programma di aggiornamento online.)"
   )
MSG_HASH(
