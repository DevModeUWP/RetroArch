      ...
      void *args, void *params_data)
{
   ...
   fill_pathname_expand_special(g_defaults.dirs[DEFAULT_DIR_ASSETS],
      ":\\menu-assets\\", sizeof(g_defaults.dirs[DEFAULT_DIR_ASSETS]));
   ...
   fill_pathname_expand_special(g_defaults.dirs[DEFAULT_DIR_RECORD_OUTPUT],
      "~\\", sizeof(g_defaults.dirs[DEFAULT_DIR_RECORD_OUTPUT]));
   fill_pathname_expand_special(g_defaults.dirs[DEFAULT_DIR_MENU_CONFIG],
      "~\\configs\\", sizeof(g_defaults.dirs[DEFAULT_DIR_MENU_CONFIG]));
   ...
   fill_pathname_expand_special(g_defaults.dirs[DEFAULT_DIR_MENU_WALLPAPERS],
   ...
   fill_pathname_expand_special(g_defaults.dirs[DEFAULT_DIR_CORE],
      ":\\emulators\\", sizeof(g_defaults.dirs[DEFAULT_DIR_CORE]));
   fill_pathname_expand_special(g_defaults.dirs[DEFAULT_DIR_CORE_INFO],
      ":\\emulators\\", sizeof(g_defaults.dirs[DEFAULT_DIR_CORE_INFO]));
   fill_pathname_expand_special(g_defaults.dirs[DEFAULT_DIR_AUTOCONFIG],
      ":\\controller-profiles\\", sizeof(g_defaults.dirs[DEFAULT_DIR_AUTOCONFIG]));
   ...
   fill_pathname_expand_special(g_defaults.dirs[DEFAULT_DIR_SYSTEM],
      "~\\data\\", sizeof(g_defaults.dirs[DEFAULT_DIR_SYSTEM]));
